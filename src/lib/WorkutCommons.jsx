...
// Menu
// ================================================================================================================
export function WorkutMenu({ githubUser }) {
  const [isMenuOpen, setMenuState] = React.useState(false);
  return (
    <WorkutMenu.Wrapper isMenuOpen={isMenuOpen}>
      <div className="container">
        <WorkutMenu.Logo src={`${BASE_URL}/logo.svg`} />
      ...
      <WorkutMenuProfileSidebar githubUser={githubUser} />
    </WorkutMenu.Wrapper>
  )
}
WorkutMenu.Wrapper = styled.header`
  width: 100%;
  background-color: #308BC5;
  .WorkutMenuProfileSidebar {
    background: white;
    position: fixed;
    z-index: 100;
    padding: 46px;
...
function WorkutMenuProfileSidebar({ githubUser }) {
  return (
    <div className="WorkutMenuProfileSidebar">
      <div>
        ...
        <WorkutProfileSidebarMenuDefault />
      </div>
    </div>
  )
}
...
// WorkutProfileSidebarMenuDefault
// ================================================================================================================
export function WorkutProfileSidebarMenuDefault() {
  return (
    <WorkutProfileSidebarMenuDefault.Wrapper>
      <nav>
        <a href="/">
...
WorkutProfileSidebarMenuDefault.Wrapper = styled.div`
  a {
    font-size: 12px;
    color: #2E7BB4;
    margin-bottom: 16px;
